...
const SECRET_PATTERNS: readonly SecretPattern[] = [
  ...
  { name: 'OpenAI Key',           severity: 'critical', pattern: /sk-(?:proj-)?[A-Za-z0-9\-_]{20,}/ },
  { name: 'Anthropic Key',        severity: 'critical', pattern: /sk-ant-[A-Za-z0-9\-_]{40,}/ },
  { name: 'SendGrid Key',         severity: 'high',     pattern: /SG\.[A-Za-z0-9\-_]{22}\.[A-Za-z0-9\-_]{43}/ },
